...
This example demonstrates the GPIO output mode, configuring the LED pin (PB02)
to be in digital output mode, and flipping the LED pin level every 250ms.
Running the program, you can see that the LED light flashes at a frequency of 2Hz.
================================================================================
测试环境：
测试用板：PY32F072_STK
MDK版本： 5.28
