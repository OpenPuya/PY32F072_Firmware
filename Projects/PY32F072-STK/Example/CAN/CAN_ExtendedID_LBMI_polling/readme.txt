...
CAN2.0 protocol, extended frames, and internal loopback polling method. The MCU
...
PA03(RX)  -->  TX
GND       -->  GND
3.Reset the STK board and observe whether the serial port prints 8byte data
0x1~0x8. If the serial port prints, it indicates that the internal loopback
