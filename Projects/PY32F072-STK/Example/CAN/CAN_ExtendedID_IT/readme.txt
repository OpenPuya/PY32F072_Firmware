...
This example demonstrates the communication function between the CAN2.0 protocol
extension frame interrupt method and the PCAN View. The MCU first automatically
sends 8-byte data 0x1~0x8 to the PCAN View. After the PCAN View receives the
data, it manually sends 8-byte data with ID 0x1234567F to the MCU through the
PCAN View. The MCU will automatically print the received data through the
serial port.
================================================================================
测试环境：
测试用板：PY32F072_STK
